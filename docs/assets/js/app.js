...
(0, _jquery2.default)('#formulario')
// field element is invalid
.on("invalid.zf.abide", function (ev, elem) {
  (0, _sweetalert2.default)('Error!', 'El formulario se envio incompleto', 'error');
})
// form validation passed, form will submit if submit event not returned false
.on("formvalid.zf.abide", function (ev, frm) {

  var formulario = (0, _jquery2.default)(this);
  _jquery2.default.ajax({
    ...
    success: function success(data) {
      ...
      (0, _sweetalert2.default)('Reserva enviada', 'Tu reservacion ha sido enviada con exito', 'success');
    }
  });
  // ajax post form 
})
